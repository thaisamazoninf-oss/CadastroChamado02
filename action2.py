...
#------------------ Adicionando Descrição ---------------------#
    ...
    if entrada_assunto in ["2","5", "6","7","9","10","11","15","16","17","18","19", "21","22","25","27","29","32","36","38","39","40","42","46","47","48","51","53","58","60","61","62","63","65","66","70", "71", "72","73","74","75","76","77","78","79"]:
        if tipo in ["AE", "E"]:
            print("\nAdicionando descrição")
            colar_texto(texto)
            #pyperclip.copy(texto)
